...
import com.its.smart.web.controller.sys.BaseControllerTest;
...
@Slf4j
public class BmcWechatAccountControllerTest extends AbstractTestNGSpringContextTests implements BaseControllerTest {

    @Autowired
    private TestRestTemplate testRestTemplate;

    private BmcWechatAccount bmcWechatAccount;
    ...
    public void testCreate() {
        ...
        HttpEntity<String> httpEntity = new HttpEntity<>(JSON.toJSONString(bmcWechatAccount), headers);
        ...
        bmcWechatAccount = JSON.parseObject(json, BmcWechatAccount.class);
    }
    ...
    public void testUpdate() {
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON_UTF8);
        log.error(bmcWechatAccount.toString());
        HttpEntity<String> httpEntity = new HttpEntity<>(JSON.toJSONString(bmcWechatAccount), headers);
        ResponseEntity<R> result = testRestTemplate.exchange("/api/admin/applications", HttpMethod.POST, httpEntity, R.class);
        log.error(result.getBody().toString());
        Assert.assertEquals(result.getStatusCode().value(), 200);
    ...
    public void testDetail() {
        ...
        multiValueMap.put("id", bmcWechatAccount.getId());
    ...
    public void testDelete() {
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON_UTF8);
        List<String> deleted = Lists.newArrayList(bmcWechatAccount.getId());
